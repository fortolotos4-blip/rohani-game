...
@section('sidebar')
<nav class="space-y-2 text-sm" x-data="{ open: null }">
...
<a href="{{ route('puzzle.index') }}"
  ...
  <a href="{{ route('tts.menu') }}"
    ...
    <span class="mt-4 inline-block text-white text-sm font-semibold
                 group-hover:underline">
      Main →
    </span>
  </a>
